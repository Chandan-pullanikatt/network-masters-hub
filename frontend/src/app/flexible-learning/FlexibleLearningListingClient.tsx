...
interface FlexibleLearningListingClientProps {
    courses: Course[];
}

export default function FlexibleLearningListingClient({ courses }: FlexibleLearningListingClientProps) {
    return (
