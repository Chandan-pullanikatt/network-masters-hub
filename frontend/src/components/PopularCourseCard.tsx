...
const PopularCourseCard: React.FC<PopularCourseCardProps> = ({ course }) => {
    ...
    return (
        <div className="flex flex-col w-full max-w-sm mx-auto bg-white rounded-2xl shadow-sm border border-[#E2E8F0] overflow-hidden h-full transition-all hover:shadow-md">
            {/* Image Container */}
